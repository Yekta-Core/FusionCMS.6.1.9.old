...
$emulators = array(
	...
	"trinity_rbac_wod_ra" => "TrinityCore (Wod) with RBAC - connected through RA",
	"trinity_rbac_wod_soap" => "TrinityCore (Wod) with RBAC - connected through SOAP",
	"trinity_rbac_legion_ra" => "TrinityCore (Legion) with RBAC - connected through RA",
	"trinity_rbac_legion_soap" => "TrinityCore (Legion) with RBAC - connected through SOAP",
